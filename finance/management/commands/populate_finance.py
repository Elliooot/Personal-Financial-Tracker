...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        transactions = [
            { 'date': '2024/02/01', 'category': 'Transportation', 'transaction_type': 'Expense', 'currency': 'GBP', 'amount': '2.95', 'account': 'Monzo', 'description': 'First Glasgow'},
            { 'date': '2024/02/01', 'category': 'Investment',     'transaction_type': 'Income',  'currency': 'GBP', 'amount': '4000', 'account': 'HSBC', 'description': 'CHRIS LIU'},
            { 'date': '2024/02/03', 'category': 'Food',           'transaction_type': 'Expense', 'currency': 'GBP', 'amount': '7.45', 'account': 'Cash', 'description': 'Subway'},
            { 'date': '2024/02/03', 'category': 'Shopping',       'transaction_type': 'Expense', 'currency': 'GBP', 'amount': '4.90', 'account': 'Revolut', 'description': 'Circuit top up'},
            { 'date': '2024/02/16', 'category': 'Food',           'transaction_type': 'Expense', 'currency': 'GBP', 'amount': '7.45', 'account': 'Cash', 'description': 'Subway'},
            { 'date': '2024/02/20', 'category': 'Food',           'transaction_type': 'Expense', 'currency': 'GBP', 'amount': '7.45', 'account': 'Monzo', 'description': 'Subway'},
        ]
