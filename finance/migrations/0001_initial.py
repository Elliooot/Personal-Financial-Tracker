# Generated by Django 5.1.5 on 2025-03-02 00:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recurring_transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='finance.recurringtransaction')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('category', models.CharField(choices=[('food', 'Food'), ('shopping', 'Shopping'), ('transportation', 'Transportation'), ('education', 'Education'), ('entertainment', 'Entertainment'), ('housing', 'Housing'), ('medical', 'Medical'), ('investment', 'Investment'), ('others', 'Others')], max_length=50)),
